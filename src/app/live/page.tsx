            ...
            <div className="track-svg-canvas" style={{ position: 'relative', backgroundColor: '#09090C', minHeight: '380px' }}>
              <svg viewBox="0 0 1375 790" width="100%" height="100%" style={{ padding: '20px', zIndex: 1, position: 'relative' }}>
                <g transform="translate(100, 45) scale(0.85)">
                  ...
                  <text x="775" y="110" fill="#00D2FF" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 1</text>
                  <text x="1025" y="410" fill="#FF8C00" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 2</text>
                  <text x="425" y="550" fill="#0055FF" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 3</text>
