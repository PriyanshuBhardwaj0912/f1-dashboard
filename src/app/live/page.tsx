            ...
            <div className="track-svg-canvas" style={{ position: 'relative', backgroundColor: '#09090C', minHeight: '380px' }}>
              <svg viewBox="0 0 1375 790" width="100%" height="100%" style={{ padding: '20px', zIndex: 1, position: 'relative' }}>
                <g transform="translate(100, 45) scale(0.85)">
                  ...
                  <path d="M 919,156 L 1145,190" stroke="#FF00A8" strokeWidth="3" fill="none" strokeDasharray="6 4" />
                  <path d="M 677,728 L 50,414" stroke="#FF00A8" strokeWidth="3" fill="none" strokeDasharray="6 4" />

                  {/* Sector label text overlays */}
                  <text x="800" y="180" fill="#00D2FF" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 1</text>
                  <text x="1150" y="240" fill="#FF8C00" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 2</text>
                  <text x="280" y="480" fill="#0055FF" fontSize="15px" fontWeight={800} textAnchor="middle">SECTOR 3</text>

                  {/* Pink DRS Detection Zone 1 Overlay and Line */}
                  <g>
                    <path d="M 740,164 L 740,240" stroke="#FF00A8" strokeWidth="2.5" fill="none" />
                  ...
                  <g>
                    <path d="M 1091,655 L 1091,720" stroke="#FF00A8" strokeWidth="2.5" fill="none" />
                  ...
                  <g>
                    <path d="M 227,537 L 227,610" stroke="#00D200" strokeWidth="2.5" fill="none" />
